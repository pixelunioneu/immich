  ...
  <form onsubmit={onSubmit} class="flex flex-col gap-4">
    {#if !success}
      <Alert color="primary" size="small" class="mb-2">
        <Stack gap={4}>
          <Text
            >Use this page to reset your admin password. Only administrators of this PixelUnion instance are allowed to
            reset their password. If you are a non-admin user, please ask your administrator to reset the password for
            you.</Text
          >
        </Stack>
      </Alert>
    ...
    {#if success}
      <Alert color="success" size="small">
        <Stack gap={4}>
          <Text
            >If the email exists and belongs to an administrator, an email will have been sent. Click the link in the
            email to reset your password.</Text
          >
        </Stack>
      </Alert>
    {/if}
